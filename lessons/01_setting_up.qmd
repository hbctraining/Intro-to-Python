...
- Accessibility as it can be installed on any computer and (and it’s **free!**)
...
::: callout-note
# Installing Anaconda
Prior to today's lesson, you should already have installed [Anaconda](https://www.anaconda.com/download) onto your computer. You should now have an application called "Anaconda Navigator". 
:::
...
::: columns
::: column
One of the applications downloaded with Anaconda is [JupyterLab](https://jupyter.org/). JupyterLab allows users to create interactive environments (notebooks) that allow you to create and share your Python code and visualizations. JupyterLab is widely used for sharing results and running analyses since you can show any intermediate results from code chunks through the notebook.
...
On the left-hand side of JupyterLab we can access the file navigator which allows us to navigate through the files on our computer and open them in JupyterLab. To begin, let us make a new folder for this workshop in our `Desktop` folder. To create a new folder click the "New Folder" button in the file navigator and title it intro_python. 

:::{.callout-tip}
# **Exercise 1**

When organizing your working directory for a particular analysis, you should separate the original data (raw data) from the intermediate datasets. For instance, you may want to create:
...
We will create all of the above directories for this exercise. When finished, your working directory should look like this:
...
| Edit     | Actions related to editing documents such as Undo, Cut, Copy, Paste, etc.                                                                                                             |
| View     | Actions that alter the appearance of JupyterLab and enable access to different windows.                                                                                                                                                           |
| Run      | Actions for running code in different ways such as through notebooks and code consoles (discussed below).                                                                                                   |
...
| Help     | A list of links for help with JupyterLab and kernels.                                                                                                                                                                |
...
We will be writing text within the cells of the Jupyter Notebook. These blocks can either be text (markdown) or code (Python). To create a new cell, click the `"+"` button in the toolbar at the top of the notebook.
...
You can run a cell by clicking on the cell and then clicking the "Run" button in the toolbar at the top of the notebook. You can also use the keyboard shortcut `Shift + Enter` to run a cell.
...
Python is trying to run the text "Add 3 and 5" as a command, which is not valid Python syntax. Aa a result, we get an `invalid syntax` error in the console. This error means that the Python interpreter did not know what to do with that command. Readd the `#` to re-comment the appropriate line.
...
Before we move on to more complex concepts and getting familiar with the language, we want to reemphasize the importance of commenting your code.
