...
One of the most common problems that programming solves is the tedium of performing the same task/calculation repeatedly. Instead of writing the same code over and over again, we can use loops to automate this process. In this lesson, we will learn about two types of loops: `for` loops and `while` loops.
