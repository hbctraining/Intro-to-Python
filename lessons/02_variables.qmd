...
Table: More Python data types. {#tbl-more_data_types}

| Type       | What it is                             |
|------------|-----------------------------------------------------|
| [list](06_lesson.qmd)       | An ordered, changeable collection of elements.        |
| [dictionary](07_lesson.qmd) | A collection of key–value pairs.  |
| [tuple](08_lesson.qmd)      | An ordered collection of elements you.   |
| [set](09_lesson.qmd)        | An unordered collection of unique elements.           |
