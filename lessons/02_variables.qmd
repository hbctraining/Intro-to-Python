...
Now that we have a basic understanding of what a variable is, let's discuss the different **data types** that hold a single value. Some of these most common data types are:
...
Booleans are another data type and the denotes `True` and `False` values. 
...
::: callout-warning
Flush out the definition of boolean a bit more and why it is useful
:::
