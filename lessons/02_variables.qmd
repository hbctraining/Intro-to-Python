...
:::{.callout-note}
You can see that when we add text around a variable, it automatically adds spaces on either side of that variable.
:::
...
- **int** - Integers
- **float** - Floating point numbers (number with decimals)
