...
The directories in Python where the packages are stored are called the libraries. The terms _package and library_ are sometimes used synonymously and there has been discussion amongst the community to resolve this. 
...
::: callout-warning
Make an aside lesson on how to do this in terminal
:::
...
:::{.callout-tip}
# **Exercise 2**
2. To ensure that you have successfully installed the libraries from the previous exercise, try running the import commands :
