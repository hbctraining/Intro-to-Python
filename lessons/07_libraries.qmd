...
In the search bar, type `numpy` and press enter. You should see the `numpy` package listed in the search results. There many be several packages that match your search as all potential search matches are listed in alphabetical order. You may have to scroll until you see the `numpy` package. 
...
::: callout-warning
Ideally someone who does not have as many environment as me should make this screenshot
:::
